...
public class hotelrepository {
    Map<String, Hotel> hotelMap = new HashMap<>(); //hotel database
    Map<Integer, User> userMap = new HashMap<>(); //user database
    Map<String, Booking> bookingMap = new HashMap<>(); //batabase for storing various booking
    Map<String, Integer> userRent = new HashMap<>(); //database to store users and their rents
